  ...
  return (
    <section className="py-28 px-4 ">
      <div className="max-w-7xl mx-auto ">
        ...
        <div className="flex flex-col md:flex-row gap-20 py-5 items-center">

          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold text-left leading-snug">
            Join Virtual Run and <br /> get Reward
          </h2>

          <p className="mb-10 max-w-full sm:max-w-lg md:max-w-xl mx-auto pt-0 md:pt-3 text-sm sm:text-base md:text-lg text-gray-700">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-5">
          {rules.map((rule, idx) => (
            ...
            >
              ...
              {/* Text - bottom */}
              <div>
                <h2 className="text-2xl  text-left font-semibold">{rule.title}</h2>
                <p className="text-md  text-left mt-2">{rule.text}</p>
              </div>
            </motion.div>
          ))}
